...
//	#error "This code must be compiled with an x86_64-elf compiler"
//#endif
// 
...
//int term_col = 0;
//int term_row = 0;
//uint8_t term_color = 0x00; // Black background, White foreground
// 
...
//			vga_buffer[index] = ((uint16_t)term_color << 8) | 'X'; // Set the character to blank (a space character)
//		}
//	}
//}
// 
...
//	term_print("Welcome to the koselig OS, kOS.\n");
//}
